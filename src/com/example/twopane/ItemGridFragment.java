...
import com.example.twopane.dummy.DummyContent;
...
public class ItemGridFragment extends GridFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setGridAdapter(new ArrayAdapter<DummyContent.DummyItem>(getActivity(),
	...
	@Override
	public void onGridItemClick(GridView listView, View view, int position,
			long id) {
